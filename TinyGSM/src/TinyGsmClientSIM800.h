 ...
 public:
  class GsmClientSim800 : public GsmClient {
   ...
   public:
    ...
    explicit GsmClientSim800(TinyGsmSim800& modem = getDefaultModem(), uint8_t mux = 0) {
      init(&modem, mux);
    }
  ...
  private:
    static TinyGsmSim800& getDefaultModem() {
      static TinyGsmSim800 defaultModem(Serial2);  // You can change Serial2 to the desired Serial port
      return defaultModem;
    }
    /*
     * Extended API
 ...
 public:
  class GsmClientSecureSim800 : public GsmClientSim800 {
   public:
    ...
    explicit GsmClientSecureSim800(TinyGsmSim800& modem = getDefaultModem(), uint8_t mux = 0)
